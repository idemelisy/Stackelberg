...
bool CoreTest::test_conditional_update_lemma_4_2() {
    ...
    assert_equal(0.4, updated.get_conditional_occupancy(0, leader_hist), 1e-6, "s'=0 per Lemma 4.2");
    assert_equal(0.6, updated.get_conditional_occupancy(1, leader_hist), 1e-6, "s'=1 per Lemma 4.2");
    return true;
}
...
bool CoreTest::test_conditional_occupancy_state_update() {
    ...
    assert_true(updated.is_valid(true), "Updated conditional occupancy state should be valid");
...
bool CoreTest::test_conditional_occupancy_state_decomposition() {
    ...
    assert_true(conditional0.is_valid(true), "Manually constructed conditional should be valid");
    return true;
}
...
bool CoreTest::test_credible_set_conditional_decomposition() {
    ...
    for (const auto& conditional : specific_conditionals) {
        assert_true(conditional.is_valid(true), "Conditional occupancy state should be valid");
